        ...
        <ModalBody color='white' pb={6} bg='gray' textAlign='center' >
          <Flex flexDir='column'>
            <Text fontSize='14px' my='1rem'>
              QUX Token Fees allow for encryption<br />
              between users to remain secure.<br /><br />

              You deserve privacy and transparency.<br />
              Our fee is only 3%.<br />
              Using a top tier credit card could cost your<br />
              merchant 6% or more, potentially raising<br />
              your prices, giving away your data, and<br />
              can cause your local merchants to give<br />
              money to outside corporations.<br />
              Point cards are poison.<br />
              Support Local.<br />
              Keep your data private.<br />
